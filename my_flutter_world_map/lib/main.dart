...
import 'package:my_flutter_world_map/data/world_map.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        color: Color.fromRGBO(215, 235, 246, 1),
        child: InteractiveViewer(
            child: SimpleMap(
          instructions: CustomMapWorld.worldMap,
          ...
          countryBorder: const CountryBorder(color: Colors.grey, width: 0.25),
          colors: id.isNotEmpty ? {id: Colors.green} : {},
        )),
      ),
    );
  }
